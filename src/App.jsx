...
const PHOTOGRAPHERS = {
  jeju: [
          ...
          packages: [
            {
              ...
              inclusiveItems: [
                ...
                "2 Dress Outfits (Shoes NOT included)",
                "2 Suits (Shirt and shoes NOT included)",
                "Accessories (Veil, Earrings, Hair acc)",
                "1 Fresh Flower Bouquet",
                "Interpreter (1 day, Styling Studio to Styling Studio)",
                "Private Van with Driver (includes Suit Pick-Up & Return)",
                "Stylist Accompaniment during Photoshoot",
              ],
          ...
          packages: [
            {
              ...
              inclusiveItems: [
                ...
                "Accessories (Veil, Earrings, Hair acc)",
                "1 Fresh Flower Bouquet",
                "Interpreter (full-day support on shooting day)",
                "Private Van with Driver (full-day support on shooting day)",
                "Stylist Accompaniment during Photoshoot",
              ],
            ...
            },
            {
              ...
              inclusiveItems: [
                ...
                "Accessories (Veil, Earrings, Hair acc)",
                "1 Fresh Flower Bouquet",
                "Interpreter (1 day, HMUD Shop to HMUD Shop)",
                "Private Van with Driver (includes Suit Pick-Up & Return)",
                "Stylist Accompaniment during Photoshoot",
              ],
              shootingTime: "5 hours",
          ...
          packages: [
            ...
            },
            {
              ...
              inclusiveItems: [
                ...
                "1 Fresh Flower Bouquet",
                "4K Cinematic Videography (3-4 min video + 15-30 sec highlight)",
                "Interpreter (1 day, Dress Studio to Dress Studio)",
                "Private Van with Driver (includes Suit Pick-Up & Return)",
                "Stylist Accompaniment during Photoshoot",
              ],
              shootingTime: "5 hours",
      ...
      packages: [
        {
          ...
          inclusiveItems: [
            ...
            "Interpreter (HMU/Dress Studio to HMU/Dress Studio)",
            "Private Van with Driver (includes Suit Pick-Up & Return)",
            "Stylist Accompaniment during Photoshoot",
          ],
          shootingTime: "4 hours",
    ...
    },
    {
      ...
      packages: [
        {
          name: "Package A",
          subtitle: "Aboutmood & Bridal Hwang",
          partners: {
            photographer: { name: "Aboutmood", instagram: "@_aboutmood" },
          ...
          inclusiveItems: [
            ...
            "Accessories (Veil, Earrings, Hair acc)",
            "1 Fresh Flower Bouquet",
            "Interpreter (1 day, Dress Shop to Dress Shop)",
            "Private Van with Driver (includes Suit Pick-Up & Return)",
            "Stylist Accompaniment during Photoshoot",
          ],
          shootingTime: "5 hours",
        ...
        {
          name: "Package C",
          subtitle: "Aboutmood & Audrey Tailor",
          partners: {
            photographer: { name: "Aboutmood", instagram: "@_aboutmood" },
        ...
        {
          name: "Package D",
          subtitle: "Aboutmood & Opus & Marshallbride",
          partners: {
            photographer: { name: "Aboutmood", instagram: "@_aboutmood" },
            hmu: { name: "Opus", instagram: "@opus_w" },
            dress: { name: "Marshallbride", instagram: "@marshallbride_jeju" },
      ...
      subPhotographers: [
        {
          ...
          packages: [
            {
              name: "Package A",
              subtitle: "Sonsungjoo Main & Makeup Muto",
              partners: {
              ...
              inclusiveItems: ["Photography Session","Hair & Makeup for Bride and Groom","2 Dress Outfits (Shoes NOT included)","2 Suits (Shirt and shoes NOT included)","Accessories (Veil, Earrings, Hair acc)","1 Fresh Flower Bouquet","4K Drone Photography (20-30 sec video)","Interpreter (1 day, Styling Studio to Styling Studio)","Private Van with Driver (includes Suit Pick-Up & Return)","Stylist Accompaniment during Photoshoot"],
            ...
            {
              name: "Package B",
              subtitle: "Sonsungjoo Main & By Moon",
              partners: {
                photographer: { name: "Main Director", instagram: "@sungjoo_son" },
              ...
              inclusiveItems: ["Photography Session","Hair & Makeup for Bride and Groom","2 Dress Outfits + 1 White Heel (KR 44~77, Heel 220~255cm)","2 Suits (Shirt and shoes NOT included, Top 95~120 / Bottom 28~39in)","Accessories (Veil, Earrings, Hair acc)","1 Fresh Flower Bouquet","4K Drone Photography (20-30 sec video)","Interpreter (1 day, Styling Studio to Styling Studio)","Private Van with Driver (includes Suit Pick-Up & Return)","Stylist Accompaniment during Photoshoot"],
              shootingTime: "5 hours", locations: "3-4 sites", originalPhotos: "1,500+", retouched: 40,
              retouchedDetail: "Customer Selected: 20 + Photographer Selected: 20",
            ...
            {
              name: "Package C",
              subtitle: "Sonsungjoo Main & Command U",
              partners: {
                photographer: { name: "Main Director", instagram: "@sungjoo_son" },
      ...
      packages: [
        {
          ...
          inclusiveItems: [
            "Photography Session",
            "Hair & Makeup for Bride and Groom",
            "2 Dress Outfits (Shoes NOT included, Basic Label)",
            "2 Suits (Shirt and shoes NOT included)",
            "Accessories (Veil, Earrings, Hair acc)",
            "1 Fresh Flower Bouquet",
          ...
          packages: [
            {
              ...
              inclusiveItems: [
                ...
                "Accessories (Veil, Earrings, Hair acc)",
                "1 Fresh Flower Bouquet",
                "Interpreter (HMUD Shop to HMUD Shop)",
                "Private Van with Driver (includes Suit Pick-Up & Return)",
                "HMUD Assistant on Shooting Date",
              ],
              shootingTime: "4 hours",
          ...
          packages: [
            ...
            },
            {
              ...
              inclusiveItems: [
                "Outdoor Photography Session",
                "Hair & Makeup for Bride and Groom",
                "3 Dress Outfits (Shoes NOT included)",
                "2 Suits (Shirt and shoes NOT included)",
                "Accessories (Veil, Earrings, Hair acc)",
                "1 Fresh Flower Bouquet",
                "Interpreter (HMUD Shop to HMUD Shop)",
          ...
          packages: [
            ...
            },
            {
              ...
              inclusiveItems: [
                "Outdoor + Studio Photography Session",
                "Hair & Makeup for Bride and Groom",
                "4 Dress Outfits (Shoes NOT included)",
                "2 Suits (Shirt and shoes NOT included)",
                "Accessories (Veil, Earrings, Hair acc)",
                "1 Fresh Flower Bouquet",
                "Interpreter (HMUD Shop to HMUD Shop)",
  ...
  seoul: [
      ...
      packages: [
        {
          ...
          partners: {
            photographer: { name: "Misang Seoul (2 Photographers)", instagram: "@__misang_seoul" },
            hmu: { name: "K Salon", instagram: "@k__salon" },
            dress: { name: "K Salon", instagram: "@ksalon_seoul" },
            suit: { name: "K Salon", instagram: "@ksalon_seoul" },
          },
          inclusiveItems: ["Photography Session (2 Photographers)","Hair & Makeup for Bride and Groom","2 Dress Outfits + 1 Heel","2 Suits (Shirt and shoes NOT included)","Accessories (Veil, Earrings, Hair acc)","1 Fresh Flower Bouquet","4K Videography (2:30 behind-the-scenes video, Original + Final)","Interpreter (1 day, Makeup Shop to Makeup Shop)","Private Van with Driver (during photoshoot)","Stylist Accompaniment during Photoshoot"],
          shootingTime: "4 hours", locations: "1 Studio + Noeul Park", originalPhotos: "1,500+", retouched: 25,
        ...
        },
        {
          ...
          inclusiveItems: ["Photography Session (2 Photographers)","Hair & Makeup for Bride and Groom","2 Dress Outfits + 1 Heel","2 Suits (Shirt and shoes NOT included)","Accessories (Veil, Earrings, Hair acc)","1 Fresh Flower Bouquet","4K Videography (2:30 behind-the-scenes video, Original + Final)","Interpreter (Makeup Shop to Makeup Shop)","Private Van with Driver (during photoshoot)","Stylist Accompaniment during Photoshoot"],
          shootingTime: "4 hours", locations: "Noeul Park + Eulwangri Beach", originalPhotos: "1,500+", retouched: 25,
          retouchedDetail: "Precise Retouching: 25 (Customer Selected)",
          priceSNS: 2570, priceNoSNS: 2670,
          addons: [
      ...
      packages: [
        {
          ...
          inclusiveItems: ["Photography Session","Hair & Makeup for Bride and Groom","2 Dress Outfits + 1 Heel","1 Suit (Shirt and shoes NOT included)","Accessories (Veil, Earrings, Hair acc)","1 Fresh Flower Bouquet","Interpreter (1 day, Makeup Shop to Makeup Shop)","Private Van with Driver (during photoshoot)","Stylist Accompaniment during Photoshoot"],
    ...
    {
      id: "seoul-3", number: "#3", name: "Seol in Seoul", instagram: "@seolinseoul_",
      packages: [
        {
          name: "Package A",
          ...
          inclusiveItems: ["Photography Session","Hair & Makeup for Bride and Groom","1 Dress Outfit + 1 Heel","1 Suit (Shirt and shoes NOT included)","Accessories (Veil, Earrings, Hair acc)","1 Fresh Flower Bouquet","Interpreter (1 day, Makeup Shop to Makeup Shop)","Private Van with Driver (during photoshoot)","Stylist Accompaniment during Photoshoot"],
        ...
        },
        {
          ...
          inclusiveItems: ["Photography Session","Hair & Makeup for Bride and Groom","2 Dress Outfits + 1 Heel","2 Suits (Shirt and shoes NOT included)","Accessories (Veil, Earrings, Hair acc)","1 Fresh Flower Bouquet","Interpreter (1 day, Makeup Shop to Makeup Shop)","Private Van with Driver (during photoshoot)","Stylist Accompaniment during Photoshoot"],
    ...
    {
      id: "seoul-4", number: "#4", name: "Kiss and Smoking", instagram: "@kiss_and.smoking",
      packages: [
        {
          name: "Package A",
          ...
          inclusiveItems: ["Photography Session","Hair & Makeup for Bride and Groom","1 Dress Outfit + 1 Heel","1 Suit (Shirt and shoes NOT included)","Accessories (Veil, Earrings, Hair acc)","1 Fresh Flower Bouquet","Interpreter (1 day, Dress Studio to Dress Studio)","Private Van with Driver (during photoshoot)","Stylist Accompaniment during Photoshoot"],
        ...
        },
        {
          ...
          inclusiveItems: ["Photography Session (2 hours)","Interpreter (2 hours, during shoot)"],
    ...
    {
      id: "seoul-5", number: "#5", name: "Deriz", instagram: "@de.riz_",
      packages: [
        {
          name: "Package A",
        ...
        },
        {
          ...
          inclusiveItems: ["Photography Session","Hair & Makeup for Bride and Groom","2 Dress Outfits + 1 Heel","2 Suits (Shirt and shoes NOT included)","Accessories (Veil, Earrings, Hair acc)","1 Fresh Flower Bouquet","Interpreter (1 day, HMUD Shop to HMUD Shop)","Private Van with Driver (during photoshoot)","Stylist Accompaniment during Photoshoot"],
    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "20px", marginTop: "60px" }}>
      ...
      <div style={{ display: "flex", gap: "16px", flexWrap: "wrap", justifyContent: "center" }}>
        {[
          ...
          { key: "seoul", label: "Seoul", sub: "5 Photographers" },
        ].map((r) => (
          <button
            key={r.key}
      ...
      <div style={{ background: "#FAFAF8", border: "1px solid #E8E0D4", borderRadius: "4px", padding: "20px 24px", marginBottom: "24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "12px" }}>
          {Object.entries(pkg.partners).map(([role, info]) => (
            <div key={role}>
              <span style={{ fontSize: "12px", color: "#666", textTransform: "capitalize" }}>{role === "hmu" ? "Hair & Makeup" : role === "dress" ? "Dress" : role === "suit" ? "Suit" : role === "videographer" ? "Videographer" : "Photographer"}</span>
